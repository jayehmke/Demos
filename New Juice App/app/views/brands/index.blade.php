		...
		<div class="panel panel-default">
		    ...
		    @foreach($brands as $brand)
		        <tr>
			        <td>{{ $brand->name }}</td>
			        <td>
				        <a class="btn btn-primary btn-lg" href="{{ URL::to('brands/' . $brand->id . '/edit') }}" role="button"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>
				        <a class="btn btn-primary btn-lg" href="#" role="button"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
				       
						{{ link_to_route('brands.destroy', 'D', $brand->id, ['data-method'=>'delete']) }}
